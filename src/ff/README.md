...
| ff-pushpin-service.pushpinworker.image.tag | string | `"1.1076.0"` |  |
...
| ff-service.image.tag | string | `"1.1076.0"` |  |
...
| ff-service.jobs.postgres_migration.image.tag | string | `"1.1076.0"` |  |
